...
$s_phone=$udata['phone'];
$res = mysqli_query($ahk_conn, "SELECT * FROM `job_card` WHERE username='$s_phone' ORDER BY `id` DESC");
if(isset($_POST['delete']) && $_POST['delete'] == "del"){
    $id = base64_decode($_POST['id']);
    $del = mysqli_query($ahk_conn,"DELETE FROM `job_card` WHERE id='$id'");
    if($del){
        ?>
        <script>
            $(function(){
        ...
        <div class="card radius-10">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div>
                        <h5 class="mb-0">All JOB INSTANT PDF LIST</h5>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="default-datatable" class="table table-bordered" width="100%">
                                            ...
                                            <tbody>
                                                 <?php
                                                $sql = mysqli_query($ahk_conn, "SELECT * FROM job_card WHERE username='$s_phone' order by id DESC");
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td align="center" valign="middle">
                                                                <a href="<?php echo $data['pdf']; ?>" download="<?php echo $data['job_card_no']; ?>.pdf"><img src="../template/ahkweb/pdf_doc.jpg" width="50" height="50" /></a>
                                                            </td>
