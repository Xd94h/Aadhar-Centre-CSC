...
$callback_url = "https://BOXIKART.COM/paytmUPI/txnResult.php";

if($gateway_type=="Advanced"){
    
$AHKWEB_TXN_URL='https://paytooi.com/order/process';

$upiuid = 'paytmqr281005050101xad2licz551u@paytm'; // Its Your Self UPI ID.

}else if($gateway_type=="Robotics"){

$AHKWEB_TXN_URL='https://paytooi.com/order/process';

$upiuid = 'paytmqr281005050101xad2licz551u@paytm'; // Its Paytm Business UPI Unique ID.



}else if($gateway_type=="Normal"){
    
$AHKWEB_TXN_URL='https://paytooi.com/stage/process';   

$upiuid = 'paytmqr281005050101xad2licz551u@paytm';  // Its UPI Unique ID, (Url:http://example.com/UPIsAccounts).
