...
<title>Payment Gateway - Test Demo</title>
 <!-- fevicon -->
      <link rel="icon" href="https://upi.cwpsolution.com/assets/upi.svg" type="image/gif" />
  <meta charset="utf-8">
...
<img class="img-fluid" src="https://upi.cwpsolution.com/assets/upi.svg" alt="alternative">
...
<div class="col-md-12 mt-5 mb-4 card p-4">
    ...
    <span>Video tutorial to help understand how the RechPay gateway works</span>
    <hr>
    <div class="row">
        <div class="col-md-6">
            <iframe width="100%" height="315" src="https://www.youtube.com/embed/m2xmStNkXjA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>
        <div class="col-md-6">
            <iframe width="100%" height="315" src="https://www.youtube.com/embed/DOtJjifTqic" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>
    </div>
</div>
