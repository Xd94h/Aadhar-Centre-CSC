...
<head>
	...
	<!--favicon-->
	<link rel="icon" href="./template/ahkweb/assets/images/favicon-32x32.png" type="image/png" />
	<!--plugins-->
							...
							<div class="card-body">
								<div class="border p-4 rounded">
									<div class="text-center mb-4">
										<h3 class="">PRINT PORTAL</h3>
										<p class="mb-0">Login to your account</p>
									</div>
									<div class="d-grid gap-3">
									
										<a href="javascript:void()" class="btn btn-google-plus"> <span>WELCOME TO PRINT PORTAL</span></a>
									</div>
