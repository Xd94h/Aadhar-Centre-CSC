						...
						<div class="card border-top border-0 border-4 border-primary">
							<div class="card-body p-5">
								...
								<form action="" method="POST" class="row g-3">
									...
									<div class="col-md-3">
										<label for="inputFirstName" class="form-label">PG TYPE</label>
										<input name="pgtype" value="<?php ahkweb('pgtype');  ?>" type="text"  placeholder="PROD/TEST"  class="form-control" id="inputFirstName">
									</div>
									<div class="col-md-3">
										<label for="inputFirstName" class="form-label">MID</label>
										<input name="mid" value="<?php ahkweb('mid'); ?>" type="text"  placeholder="MID"  class="form-control" id="inputFirstName">
									</div>
									<div class="col-md-3">
										<label for="inputFirstName" class="form-label">M Key</label>
										<input name="mkey" value="<?php ahkweb('mkey');  ?>" type="text"  placeholder="M Key"  class="form-control" id="inputFirstName">
									</div>
									<div class="col-md-3">
										<label for="inputFirstName" class="form-label">Callback URL</label>
										<input name="callback_url" value="<?php ahkweb('callback_url'); ?>" type="text"  placeholder="Call Back URL"  class="form-control" id="inputFirstName">
									</div>
									<hr>
									<div class="col-md-2">
									...
									<div class="col-md-6">
										...
										Paytm <input type="checkbox" name="paytm"  <?php if($webdata['paytm'] == 1){echo "value='1' checked"; }else{ echo "value='1'";} 
										?> > -
										PAYU <input type="checkbox" name="payu" <?php if($webdata['payu'] == 1){echo "value='1' checked"; }else{ echo "value='1'";} ?> > -
									...
									<div class="col-md-3">
										<label for="inputFirstName" class="form-label">PAYU KEY</label>
										<input name="payu_mkey" value="<?php ahkweb('payu_mkey');   ?>" type="text"  placeholder="PAYU KEY"  class="form-control" id="inputFirstName">
									</div>
									<div class="col-md-6">
										<label for="inputFirstName" class="form-label">PAYU SALT</label>
										<input name="salt" value="<?php ahkweb('salt');   ?>" type="text"  placeholder="PAYU SALT"  class="form-control" id="inputFirstName">
									</div>
									<div>PAYU GATEWAY DETAILS</div>
									<div class="col-md-6">
									...
									<div>API DETAILS</div>
									<div class="col-md-6">
										<label for="inputFirstName" class="form-label">Enter APIZONE API Key Below <a target="_blank" href="https://apizone.in">Get API Key from here</a></label>
										<input name="api_key" value="<?php ahkweb('nsdl_api_key');   ?>" type="text"  placeholder="API KEY"  class="form-control" id="inputFirstName">
									</div>
									<hr>
									...
									<div class="col-md-6">
										...
										<select name="HomeTemplatename" class="form-control" id="">
											...
											<option <?php if($webdata['HomeTemplatename']== "payoon"){echo "selected";} ?> value="payoon">Payoon</option>
										</select>
									</div>
									<div class="col-12">
