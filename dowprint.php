     ...
     <div class="content-wrap">
            <div class="main">
			    <div class="col-md-12">
                  ...
                  <h1>Ayushman Card Print FREE<sup>New</sup></h1>
							 </div>
							
						</div>

 <marquee width="100%" style="color:white;background:#32166E;font-size:20px;"><b>👉आवश्यक सूचना:-New Upadete :- Ayusman Golden Cards automaitics download Reday --👉Ready To Use Ayushman Card Print 100% Working Now👈</b> </marquee>
						<!-- /# row -->
...
<div class="modal fade" id="proc_modal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="exampleModalCenterLabel" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<center>
				<img src="https://mib.gov.in/sevasamarpan/loading.gif">
...
if(isset($_POST['p1']))
{
 ...
 $v = file_get_contents('https://roboprint.in/api/jaan.php?'.$type.'='.$flno.'&stateid='.$stid);
...
$userid= $_SESSION[ 'userid' ];
 ...
 <table border='1' cellpadding='10px' width='100%'>
  <tbody><tr>
    ...
    <td>$fatherName</td>
    <td>$createdOn</td>
    <td><form action='downlord11.php' method='post' target='_blank'>
