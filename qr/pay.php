...
<head>
    ...
    <link rel="shortcut icon" href="https://tccservice.in/public/uploads/all/V1Nhk6tW8FrtCAzxbkDHdYy1x3LX4bj1toFV4AUs.svg">
                    ...
                    <div class="card card-size border">
                        <div class="card-body">
                            <div class="login-signin">
                                ...
                                <img class="qr_code_img" src="<?php echo $base64; ?>" alt="Scan and Pay" srcset="" style="padding: 2rem 2.25rem 2rem 2.25rem;">
                                <div class="col-md-4">
