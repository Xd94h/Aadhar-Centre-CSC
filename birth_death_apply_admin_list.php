        ...
        <div class="card radius-10">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div>
                        <h5 class="mb-0">All Birth/Death PDF LIST</h5>
                    </div>
...
<?php
$res = mysqli_query($ahk_conn,"SELECT * FROM certificate_applications  ORDER BY id DESC");
if(mysqli_num_rows($res)>0){
    ...
    while($data = mysqli_fetch_assoc($res)){
        ...
        <tr>
            ...
            <td class="text-center"><?php echo strtoupper($data['certificate_type']); ?></td>
            ...
            <td class="text-center"><?php echo strtoupper($data['applicant_aadhar']); ?></td>
            <td class="text-center"><?php echo strtoupper($data['mother_name']); ?></td>
