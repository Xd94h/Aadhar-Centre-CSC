        ...
        <div class="card radius-10">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div>
                        <h5 class="mb-0">All Epic PDF LIST</h5>
                    </div>
                    ...
                    <table id="example2" class="table align-middle mb-0">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th class="text-center">Epic Number</th>
...
<?php
$res = mysqli_query($ahk_conn,"SELECT * FROM epictopdf_applications  ORDER BY id DESC");
    ...
    while($data = mysqli_fetch_assoc($res)){
        ...
        <tr>
            ...
            <td class="text-center">
                  <div class="ms-2">
                        <h6 class="mb-1 font-14"><?php echo strtoupper($data['epicnumber']); ?></h6>
