        ...
        <div class="card radius-10">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div>
                        <h5 class="mb-0">All Passport PDF LIST</h5>
                    </div>
...
if(isset($_GET['apid'])&& $_GET['track'] =='true'){
    ...
    $application_no = getSafe($_GET['apid']); // Application Number base64 Encoded
        ...
        if($resdata['status'] == '1'){
            if(ahkQuery("UPDATE passport_applications SET aadhaar_no='".$resdata['aadhaar_no']."', status='success', pdf_link='".$resdata['pdf_link']."'  WHERE application_no='$apid' ")){
...
$res = mysqli_query($ahk_conn,"SELECT * FROM passport_applications WHERE appliedby='".$udata['phone']."'  ORDER BY id DESC");
