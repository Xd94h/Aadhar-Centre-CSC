		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="row">
				    ...
				    <img src="images/genrate.png" width="620" height="90" style="border-style: solid;border-width: 3px">
				    <img src="images/duplicate.png" width="620" height="90" style="border-style: solid;border-width: 3px">
                     <hr/>
							...
							<div class="card-body p-5">
								...
								<form action="" method="POST" class="row g-3">
									...
									<h5 class="text-warning ">Application Fee: <?php  
										$price = mysqli_fetch_assoc(mysqli_query($ahk_conn,"SELECT price FROM pricing WHERE service_name='no_uid_crrosponding'")); 
										echo "₹" .$price['price'];
										?></h5>
