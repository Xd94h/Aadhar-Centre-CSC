					...
					<div class="col-xl-10 mx-auto">
						...
						<div class="card border-top border-0 border-4 border-primary">
							<div class="card-body p-5">
							    <h6 class="text-danger ">This Portal is Fully Advance  DL PDF find in 5-15 minutes</h6>
								...
								<form action="" method="POST" class="row g-3">
									...
									<div class="col-md-3">
										<label for="inputLastName" class="form-label">DL NUMBER</label>
										<input name="dl_no" type="text" placeholder="BR3365757768789" class="form-control" >
									</div>
									<div class="col-md-3">
									...
									<h5 class="text-warning ">Application Fee: <?php  
										$price = mysqli_fetch_assoc(mysqli_query($ahk_conn,"SELECT price FROM pricing WHERE service_name='dl_pdf'")); 
										echo "₹" .$price['price'];
										?></h5>
