        ...
        <div class="card radius-10">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div>
                        <h5 class="mb-0">Aadhar Update Reports</h5>
                    </div>
                    ...
                    <table id="example2" class="table align-middle mb-0">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th class="text-center">URN Number</th>
...
$res = mysqli_query($ahk_conn,"SELECT * FROM pan_card_applications WHERE appliedby='".$udata['phone']."'  ORDER BY id DESC");
            ...
            <td class="text-center">
                <?php
                    if($data['status']=="pending"){
                        ?>
                        <div class="badge rounded-pill bg-light-warning text-warning w-100">Enrollment Under Process
                        </div>
                        <?php
                    }else if($data['status']=="success"){
                            ?>
                            <div class="text-center">
                                <a download="<?php echo $data['aadhaar_no'] ?>" href="<?php echo $data['pdf_link'] ?>" class="btn btn-sm btn-success">Download ACK SLIP</a>
                            </div>
                            <?php
                    }
                ?>
