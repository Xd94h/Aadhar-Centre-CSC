        ...
        <div class="card radius-10">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div>
                        <h5 class="mb-0">Flight Ticket Booking History</h5>
                        <h5 class="mb-0"><a href="ktrav_list.php" target="_blank" class="btn btn-success">Booking History</a>  <a href="https://wa.me/917481887848" target="_blank" class="btn btn-success">CANCEL TICKET</a> <a href="https://wa.me/917481887848" target="_blank" class="btn btn-success">Boarding Pass</a></h5>
                    </div>
...
if(isset($_GET['apid'])&& $_GET['track'] =='true'){
    ...
    $application_no = getSafe($_GET['apid']); // Application Number base64 Encoded
        ...
        if($resdata['status'] == '1'){
            if(ahkQuery("UPDATE ktrav SET aadhaar_no='".$resdata['aadhaar_no']."', status='success', pdf_link='".$resdata['pdf_link']."'  WHERE application_no='$apid' ")){
...
$res = mysqli_query($ahk_conn,"SELECT * FROM ktrav WHERE appliedby='".$udata['phone']."'  ORDER BY id DESC");
                    ...
                    if($data['status']=="pending"){
                        ...
                        <?php
                            ...
                            <div class="text-center">
                                <a download="<?php echo $data['aadhaar_no'] ?>" href="<?php echo $data['pdf_link'] ?>" class="btn btn-sm btn-success">Print Ticket</a>
                            </div>
                            <?php
                    }
                ?>
